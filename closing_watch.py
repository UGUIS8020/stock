...
DEFAULT_SHARES   = 200      # 2026-08-01: 100→200（2026-08-06: 300へ一時変更したが資金所要額を
                            ...
                            # 2026-08-14: 一時300株へ変更したが、STRONG日の最悪ケース超過が
                            # 約76%(1,799万円)と大きく、また「資金不足時に削られる候補は
                            # 現行の並び順(RBスコア降順)だと、むしろ成績の良い7〜12位が
                            # 犠牲になりやすい」という未解決の懸念([[project_position_size...]]
                            # 参照)もあったため、ユーザー判断で200株に再度差し戻し。
