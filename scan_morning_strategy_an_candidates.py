...
# ── 戦略AN 判定条件（2026-08-09 検証済み。変更する場合は再検証すること）──
SCORE_MIN   = 1.5
SCORE_MAX   = 3.0
RATIO_MIN   = 1.4
RISE_MIN    = -1.2
    ...
    for code in codes:
        ...
        rows.append({
            ...
            "reason": (f"戦略AN: score{score:.1f}×ratio{ratio:.1f}倍×寄引{today_rise:+.1f}%"
                       ...
                       f" - 検証済み条件(2年OOS 勝率69.8%/平均+0.393%)"),
        })
